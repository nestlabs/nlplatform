...
/*
 *    Description:
 *      This file contains macro defines of the MX25R6435F SPI flash chip.
 *
 */

#ifndef __MX25R6435_H_INCLUDED__
#define __MX25R6435_H_INCLUDED__
...
#define MX25R6435_MAX_SPI_FREQ_HZ   (80000000)              /* 80MHz */
#define FLASH_SPI_MODE              SPI_MODE_0

/* Size parameters */
#define FLASH_SPI_SIZE              (0x800000)              /* 8MB */
...
/* MX25R6435F Status Register and masks */
...
#define FLASH_SPI_MEMORY_DENSITY_ID (0x17)

/* delay time for different operations. DELAY_MSEC * DELAY_LOOP_COUNT == total delay time */
#define PP_DELAY_MSEC               (1)
#define PP_DELAY_LOOP_COUNT         (8)   /* PageProgram 256B, Typ. 0.85ms, Max. 4.0ms */
#define BE_DELAY_MSEC               (10000)
#define BE_DELAY_LOOP_COUNT         (15)  /* ChipErase Typ. 50s, Max. 150s */
#define SE_DELAY_MSEC               (75)
#define SE_DELAY_LOOP_COUNT         (50)  /* BlockErase64K Typ. 480ms, Max. 3000ms */
#define SSE_DELAY_MSEC              (10)
#define SSE_DELAY_LOOP_COUNT        (30)  /* SectorErase4K Typ. 40ms, Max. 240ms */

#endif /* __MX25R6435_H_INCLUDED__ */
